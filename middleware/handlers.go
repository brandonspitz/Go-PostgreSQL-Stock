...
import (
	...
	"github.com/brandonspitz/Go-PostgreSQL-Stock/models"
...
func DeleteStock(w http.ResponseWriter, r *http.Request) {
	...
	id, err := strconv.Atoi(params["id"])
	if err != nil {
		log.Fatalf("Unable to convert string to int. %v", id)
	}

	deletedRows := deleteStock(int64(id))

	msg := fmt.Sprintf("Stock deleted successfully. Total number of rows/records %v", deletedRows)
	res := response{
		ID:      int64(id),
		Message: msg,
	}
